...
const Login = () => {
  ...
  // ===============================================================
  const { signIn, signInWithGoogle, loading, gitHubSign } = UseAuth();
          ...
          <div className="">
            <div className="min-h-screen shadow-xl ">
              <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 text-gray-900">
                <div className="mb-8">
                  <h1 className="my-3 text-4xl font-bold bg-gradient-to-br from-cyan-200 to-green-600 text-transparent bg-clip-text">
                    Welcome To <br /> Challenge Crafter
                  </h1>
                ...
                >
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="lg:w-[370px] px-3 py-2 border rounded-md border-gray-300 focus:outline-cyan-500 bg-gray-200 text-gray-900"
                  ...
                  <div>
                    {loading ? (
                      ...
                      <button
                        type="submit"
                        className="bg-cyan-500 w-full rounded-md py-3 text-white hover:bg-cyan-700"
                      >
                        Login
                      </button>
                    )}
